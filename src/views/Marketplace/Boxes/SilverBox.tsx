  ...
  return (
    <>
      <BannerSoccer src={backgroundSoccerImage?.src} isMobile={isMobile}>
        <PapeStyled>
          <HeadingBorder mt="32px" width="100%" src={borderImage?.src} isMobile={isMobile} style={{ color: '#c0c0c0' }}>
            Silver box
          </HeadingBorder>
          <Grid my="30px" gridGap="24px" gridTemplateColumns={['1fr', null, null, '3fr 2fr']}>
            <StyledFlexWrapper>
              <StyledSoccerBox p={['30px 0px', null, '30px']}>
                ...
                <Video maxWidth="300px" maxHeight="300px" src="/videos/Silver.mp4" />
            ...
            <Flex flexDirection="column" justifyContent="space-between">
              ...
              <Flex mt={['32px', null, '0px']} flexDirection="column">
                ...
                <VariousKickers
                  rarities={[
                    { rarity: 'Common', background: 'rgba(68, 243, 107, 0.7)', percent: '40' },
                    { rarity: 'Rare', background: 'rgba(44, 66, 228, 0.7)', percent: '37' },
                    { rarity: 'Epic', background: 'rgba(118, 23, 183, 0.7)', percent: '20' },
                    { rarity: 'Legendary', background: 'rgba(255, 210, 59, 0.5)', percent: '3' },
                  ]}
                />
              </Flex>
