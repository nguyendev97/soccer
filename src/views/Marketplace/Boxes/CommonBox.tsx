...
import { CARDS_COMMON, CARDS_EPIC, CARDS_RARE, EQUIPS_COMMON, EQUIPS_EPIC, EQUIPS_RARE } from './constants'
          ...
          <Grid my="30px" gridGap="24px" gridTemplateColumns={['1fr', null, null, '3fr 2fr']}>
            <StyledFlexWrapper>
              <StyledSoccerBox p={['30px 0px', null, '30px']}>
                ...
                <Video maxWidth="300px" maxHeight="300px" src="/videos/Common.mp4" />
            ...
            <Flex flexDirection="column" justifyContent="space-between">
              ...
              <Flex mt={['32px', null, '0px']} flexDirection="column">
                ...
                <VariousKickers
                  rarities={[
                    { rarity: 'Common', background: 'rgba(68, 243, 107, 0.7)', percent: '82' },
                    { rarity: 'Rare', background: 'rgba(44, 66, 228, 0.7)', percent: '13' },
                    { rarity: 'Epic', background: 'rgba(118, 23, 183, 0.7)', percent: '5' },
                    { rarity: 'Legendary', background: 'rgba(255, 210, 59, 0.5)', percent: '0' },
                  ]}
                />
              </Flex>
