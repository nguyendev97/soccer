...
const InputDecimal = styled(Input)`
  font-weight: 400;
  font-size: 15px;
  box-shadow: none;
      ...
      <Flex flexDirection="column" mb="24px">
        ...
        <Flex flexWrap="wrap">
          ...
          <Flex alignItems="center">
            ...
            <Text color="primary" bold ml="2px" style={{ marginTop: '4px' }}>
              %
            </Text>
          </Flex>
        </Flex>
        {!!slippageError && (
          <Text bold fontSize="13px" color={slippageError === SlippageError.InvalidInput ? 'red' : '#FF8A00'} mt="8px">
            {slippageError === SlippageError.InvalidInput
