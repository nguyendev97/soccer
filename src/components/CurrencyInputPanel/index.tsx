...
const CurrencySelectButton = styled(Button).attrs({ variant: 'text', scale: 'sm' })<{ zapStyle?: ZapStyle }>`
  ...
  ${({ zapStyle, theme }) =>
    ...
    css`
      ...
      border-radius: ${zapStyle === 'zap' ? '0px' : '4px'} 4px 0px 0px;
      height: auto;
    `};
`
...
export default function CurrencyInputPanel({
  ...
  const [choosePercent, setChoosePercent] = useState<number>(0)
        ...
        <Flex>
          ...
          >
            <Flex alignItems="center" justifyContent="space-between">
              ...
              {pair ? (
                <Text id="pair" fontFamily="Rubik" fontWeight="500" color="textSubtle1">
          ...
          <InputRow selected={disableCurrencySelect}>
            ...
            {account && currency && selectedCurrencyBalance?.greaterThan(0) && !disabled && label !== 'To' && (
              <Flex alignItems="right" justifyContent="right">
                {showQuickInputButton &&
                  ...
                  [25, 50, 75].map((percent) => (
                    <Button
                      ...
                      scale="xs"
                      mr="5px"
                      variant={showMaxButton && percent === choosePercent ? 'primary' : 'secondary'}
                ...
                {showMaxButton && (
                  <ButtonLight onClick={onMax} scale="xs" variant="secondary" style={{ textTransform: 'uppercase' }}>
                    {t('Max')}
                  </ButtonLight>
                )}
              </Flex>
