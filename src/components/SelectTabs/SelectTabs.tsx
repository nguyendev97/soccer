...
const DropDownHeader = styled.div`
  ...
  @media (max-width: 767px) {
    background: ${({ theme }) => theme.colors.buttonSecondaryActive};
    border: 1px solid ${({ theme }) => theme.colors.buttonSecondaryActive};
  }
`
...
const SelectTabs: React.FunctionComponent<React.PropsWithChildren<SelectProps>> = ({
  options,
  onOptionChange,
  ...
  return (
    <DropDownContainer isOpen={isOpen} {...props}>
      <DropDownHeader onClick={toggling}>
        <TextSelect color={!optionSelected && placeHolderText ? 'text' : undefined}>
